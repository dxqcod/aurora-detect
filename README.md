...
- 💻 Скрипт находится в каталоге  [start.sh](scripts/start.sh)
---
...
- 💻 Скрипт находится в каталоге  [timelaps.sh](scripts/timelaps.sh)
---
...
- 💻 Скрипт находится в каталоге  [color_detect.sh](scripts/color_detect.sh)
---
...
- 💻 Скрипт находится в каталоге  [create_vid.sh](scripts/create_vid.sh)
---
...
- 💻 Скрипт находится в каталоге  [video_print_vk_auto.py](scripts/video_print_vk_auto.py)
---
