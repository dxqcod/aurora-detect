...
📡 Устройство для автоматической сьемки timelaps, а также определени налиячия полярного сияния. Многофункциональность расширена до автоматической сьемки неба через равные промежутки времени, их склейки в timelaps, закачки на сервер, оповещений и тд.  
