...
| ![Aurora](docs/photos/aurora2.jpg) | ![Meteor](docs/photos/meteor.jpg) | ![Halo](docs/photos/galo.jpg) |
|:----------------------------------:|:---------------------------------:|:-----------------------------:|
| Полярное сияние                    | Метеор                            | Лунное гало                   |

| ![Aurora](docs/photos/aurora1.jpg) | ![Aurora](docs/photos/aurora3.jpg) | ![Placeholder](docs/photos/demo.jpg) |
|:----------------------------------:|:----------------------------------:|:-----------------------------------:|
| Сияние (пример 1)                  | Сияние (пример 2)                  | Дополнительно                       |
