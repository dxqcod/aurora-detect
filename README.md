...
📡 Многофункциональное устройство для автоматической сьемки timelaps и определени налиячия полярного сияния. Насыщен фичами вроде поворотного устройства с направленными антенами, переключения картики с камеры на поворотке на камеру бпла, температурными датчики, управления системой охлаждения, отображения на пульте дисплея параметров таких как угол поворота и тд.  
...
| **Блок управления** — контроллер на ESP8266 + LoRa. Здесь же собрана основная электроника от ретранслятора. Все это помещено в пластиковый пищевой контейнер для защиты  от осадков. <br> В коробке поместилось:  <br> - Трансивер lora на микросхеме E220-900T22S, антена от него справа выходит.  <br> - Видеопередатчик SpeedyBee TX800, который скидывает видеосигнал к оператору, виден внизу на фото, сидит на радиаторе, на выход подключена аннтена skyzone, слава сбоку выходит. <br> - Приемник elrs, на фото сверху, аннтена диполь слева сверху  выходит. <br> - Внизу вентилятор охлаждения, включается по заданной температуре, тамже датчик температуры DS18B20. <br> - Сверху автомат 10А 220В, так так ретранслятор у меня стационарный и есть возможность тада 220 вольт завести. Под ним блок питания, на выходе которого 12в, и ниже вторичный стабилизатор на 5В для ESP8266 Wemos Mini. <br> - Текже поместилось пару типовых реле от Ардуино. Одно которое по команде подает питание на ретраслятор, другое по температуре включает вентилятор, третье переключает видеосигнал с камеры поворотной платформы на камеру дрона.    | <img src="docs/photos/station.jpg" width="200"/> <img src="docs/photos/station_open.png" width="200"/> |
| **Блок антенн**  <br> - Антенна управления  11-ти элементная пушка на 2,4 ГГц. <br> - Антенна видео - патч на 5,8 ГГц. <br> - Сверху видеокамера наблюдения и позиционирования. Оператор сначала вращает платформу и смотрит в эту камеру, выбирая направление, потом переключается на камеру дрона. <br> - Видеоприемник спрятан в небольшом коробе сразу за антенной. <br> - Передатчик управления elrs на 2,4 ГГц также в коробке за антенной | <img src="docs/photos/platform.jpg" width="200"/>   <img src="docs/photos/antenna_.png" width="200"/>|
| **Поворотная платформа** — управляемые сервоприводы TD-8320MG. Смонтированы один над другим. Каждый поворачивает на угол 180 градусов, совместно имеем 360 градусов. Изначально хотелось поставить серву на 360, но такой не нашел. Потом думал поставить шаговый двигатель, но серва победила, так как её можно отправить на необходимый угол и быть уверенным, что она в него установилась. Этот угол отображаентся на пульте оператора. С шаговым двигателем нужно каким-то дополнительным образом проверять установился ли он в нужное направление. Здесь же находится отдельный блок питания для серв и реле, которое его включает при необходимости. | <img src="docs/photos/rotating_platform.png" width="200"/>   <img src="docs/photos/servos.png" width="200"/>|
| **Пульт оператора** <br> - В середине находится потенциометр с помощь которого выставляется угол поворота антенн. Поворотом антенн можно управлять как до, так и во время полета, доворачивая на необходимый угол. <br> - Дисплей, на котором отображается: <br>    угол поворота антенны <br>    включчен или выключен ретранслятор <br>    температура блока управления <br>    источник видеосигнала: дрон или камера на поворотной платформе <br> - Кнопка подачи питания на ретранслятор. Lora поддерживает двустороннюю связь, так что рядом имеется светодиод синего цвета, который загорается если с ретранслятора вернулась команда, подтверждающая его включение. <br> - Тумблер подачи питания на сам пульт. Рядом с ним светодиод желтый, который  нужен больше для того чтобы немного нагрузить повербанк. Дело в том, что микросхема LoRa E220-900T22S потребляет чрезвычайно мало тока и повербанк может через какоето время выключиться, решив, что нагрузка отсутствует  <br> Пульт питается от элемента 18650, внутри имеется плата зарядки. <br> Внизу под корпусом видна микросхема LoRa E220-900T22S   | <img src="docs/photos/remote_control.png" width="200"/> |
| **БПЛА** — FPV борт со своей камерой |  |

<br>

## ⏩ Переключение камер
Оператор вначалеле на своем мониторе видит картинку с камеры, установленной на поворотной платформе ретранслятора. Затем, когда он выбрал направление, в котором будет лететь, нажимает кнопку на пульте управления и картинка переключается на камеру дрона. Переключение можно делать и вовремя полета, уточняя нужное направление. 
<p align="center">
  <a href="docs/photos/camera.png">
    <img src="docs/photos/camera.png" width="800" />
  </a>
</p>
